...
module.exports.linear = function linear(length, rotation) {
...
module.exports.exponential = function exponential(length, rotation) {
    var curve = new Float32Array(length),
        i, x,
        scale = length - 1,
        index;
...
module.exports.sCurve = function sCurve(length, rotation) {
    var curve = new Float32Array(length),
        i,
...
module.exports.logarithmic = function logarithmic(length, base, rotation) {
    var curve = new Float32Array(length),
        index,
        x = 0,
        i;
